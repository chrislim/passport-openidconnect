 ...
 *   - `getState` an optional method that generates the state instead of auto-generating it.
 *                The request will be passed in as an argument.
 *
 * @constructor
