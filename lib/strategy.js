...
function Strategy(options, verify) {
  ...
  this._getState = options.getState; // optional getState to generate custom state query variable
  this._stateStore = options.store || new SessionStateStore({ key: this._key, getState: this._getState });
